...
NITRO_NODE_VERSION=ghcr.io/layr-labs/nitro-eigenda:ethenotethan--update-eigenda-version
...
if $force_init; then
    ...
    if $l2anytrust; then
        ...
        docker compose run scripts --l2owner $l2ownerAddress  write-l2-chain-config --anytrust  --eigenda $eigenda
    else
